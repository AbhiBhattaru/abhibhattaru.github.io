...
HTML('
  <ol>
    ...
    <li>V Zhang, B Koa, AJ Borja, S Padmanhabhan, <b>A Bhattaru</b>, WY Raynor, C Rojulpote, SM Seraj, TJ Werner, C Rajapakse, A Alavi, ME Revheim. Diagnosis and Monitoring of Osteoperosis with Total-Body 18F-Sodium Fluoride Positron Emission Tomography/Computed Tomography. <em>PET Clinics.</em></li>
    <li><b>A Bhattaru</b>, N Deshmukh, S Makkapati, N Nakamitsu. Detecting Organ Failure in Motor Vehicle Trauma Patients: A Machine Learning Approach. <em>IEEE Xplore.</em>
</li>
  </ol>
     '),
br()
